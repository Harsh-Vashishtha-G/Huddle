          ...
          {[1,2,3].map(i => (
            <div key={i} className="glass-card flex items-center justify-between rounded-2xl p-5">
              <div className="space-y-2">
                ...
                <div className="h-3 w-52 rounded bg-white/4" />
                <div className="h-3 w-40 rounded bg-white/3" />
              </div>
              <div className="flex gap-2">
                <div className="h-8 w-20 rounded-xl bg-emerald-500/15" />
                <div className="h-8 w-20 rounded-xl bg-red-500/10" />
              </div>
            </div>
          ))}
        </div>
